 ...
 */
async function getRecurringTransactions(databases) {
 ...
 */
function getNextRecurringDate(originalDate) {
 ...
 */
async function transactionExistsForMonth(databases, originalTransactionId, targetMonth, targetYear) {
 ...
 */
async function createRecurringTransaction(databases, original, newDate) {
    const now = new Date();
    ...
    if (original.account_id)
        newTransaction.account_id = original.account_id;
    if (original.credit_card_id)
        newTransaction.credit_card_id = original.credit_card_id;
    if (original.category)
        newTransaction.category = original.category;
    if (original.description)
        newTransaction.description = original.description;
 ...
 */
async function processRecurringTransactions(databases) {
