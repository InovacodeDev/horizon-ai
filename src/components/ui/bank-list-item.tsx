    ...
    return (
      <button
        ...
        className={cn(
          ...
          "hover:bg-on-surface/[0.08] focus:bg-on-surface/[0.12]",
      ...
      >
        ...
        {/* Bank Name */}
        <span className="flex-1 text-left text-base leading-6 font-normal text-on-surface">
          {bankName}
        </span>

        {/* Trailing Chevron Icon */}
        <ChevronRight
          className="w-6 h-6 text-on-surface-variant flex-shrink-0"
          aria-hidden="true"
        />
      </button>
    );
