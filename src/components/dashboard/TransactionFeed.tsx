        ...
        {deduplicatedTransactions.length === 0 ? (
          ...
          <div className="space-y-1">
            {deduplicatedTransactions.map((transaction) => (
              <div
                key={transaction.id}
                className="flex items-center justify-between py-3 px-2 hover:bg-[hsl(var(--md-sys-color-on-surface)/0.08)] rounded-[var(--md-sys-shape-corner-small)] transition-colors duration-[var(--md-sys-motion-duration-short2)] ease-[var(--md-sys-motion-easing-standard)]"
              >
