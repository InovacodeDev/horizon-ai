...
export const DotsVerticalIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const WalletIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M16 21V11a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v10" />
        <path d="M18 16.5h.01" />
    </svg>
);
...
export const CarIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14 16H9m10 0h1.12a2 2 0 0 0 1.9-1.44l1.2-5.4A1 1 0 0 0 21.28 8H5.72a1 1 0 0 0-.97.72l-1.2 5.4A2 2 0 0 0 5.48 16H8" />
...
export const PlaneIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1.5-1.5-3-1-4.5 0L13 6.5 5 8l-1.5 1.5L2 14l6.5 2.5L10 22l4-1.5-1.2-5.2z" />
    </svg>
);
...
export const ReceiptIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 2v20l4-4 4 4 4-4 4 4V2Z"/><path d="M16 10h-4"/><path d="M16 6h-4"/><path d="M8 10h.01"/><path d="M8 6h.01"/></svg>
);
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5a3 3 0 1 0-5.993.131M12 5a3 3 0 1 0 5.993.131M12 5a3 3 0 1 1 .13-5.993M12 5a3 3 0 1 1 .13 5.993M5.003 16.13A3 3 0 1 0 2.13 21.99M5.003 16.13a3 3 0 1 1 5.862-2.864M18.997 16.13a3 3 0 1 1 2.864 5.862M18.997 16.13a3 3 0 1 0-5.862-2.864M12 15a3 3 0 1 0-5.993.131M12 15a3 3 0 1 0 5.993.131"/><path d="M12 15a3 3 0 1 1 .13-5.993"/><path d="M12 12v3"/><path d="M12 9V5"/><path d="m4.01 14.99 3.49-1.5"/><path d="m16.51 13.5 3.49 1.49"/><path d="m7.5 16.5-1-3.49"/><path d="m17.49 13.01-1 3.49"/></svg>
);

export const ShieldLockIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="M12 16a2 2 0 0 0-2 2v2"/><path d="M12 12v2"/><rect width="4" height="4" x="10" y="14" rx="2"/></svg>
);
...
export const SparklesIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m12 3-1.9 1.9-1.9-1.9-1.9 1.9L4.4 3l1.9 1.9L3 6.8l1.9 1.9-1.9 1.9L6.8 12l-1.9 1.9 1.9 1.9L3 17.2l1.9 1.9 1.9-1.9 1.9 1.9 1.9-1.9 1.9 1.9 1.9-1.9 1.9 1.9-1.9-1.9 1.9-1.9-1.9-1.9L17.2 12l1.9-1.9-1.9-1.9L21 6.8l-1.9-1.9-1.9 1.9Z" />
  </svg>
);

export const QrCodeIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="5" height="5" x="3" y="3" rx="1"/><rect width="5" height="5" x="16" y="3" rx="1"/><rect width="5" height="5" x="3" y="16" rx="1"/><path d="M21 16h-3a2 2 0 0 0-2 2v3"/><path d="M11 8H8"/><path d="M8 8v3"/><path d="M11 11h3"/><path d="M8 16h3"/><path d="M16 8h-2a2 2 0 0 0-2 2v2"/></svg>
);
